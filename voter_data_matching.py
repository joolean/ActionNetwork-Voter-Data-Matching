...
@app.cell
def __(people_df, pl):
    #pull all Solidarity Tech users
    import marimo
    ...
    def separate_by_reg_status(mo):
        ...
        # Flatten the 'solidarity_tech_registration_status' column
        ...
        # Flatten data in `registered` by selecting the label from columns
        ...
        unknown_registration_pd.to_csv("/Users/avonleafisher/Downloads/AllNYSVoters_20250402/solidarity_tech_without_registration.csv")
...
def __():
    ...
    sol_tech = pd.read_csv(
        "/Users/avonleafisher/Downloads/AllNYSVoters_20250402/solidarity_tech_without_registration.csv",
    ...
    match_results_df = match_results_df.drop_duplicates(keep="first")
...
def __(pd):
    ...
    # NYC residential ZIP codes (abbreviated list — can expand as needed)
    nyc_zip_codes = {
        ...
        '10040', '10451', '10452', '10453', '10454', '10455', '10456', '10457',
        '10458', '10459', '10460', '10461', '10462', '10463', '10464', '10465',
        '10466', '10467', '10468', '10469', '10470', '10471', '10472', '10473',
        '10474', '10475', '11201', '11203', '11204', '11205', '11206', '11207',
        ...
        '11233', '11234', '11235', '11236', '11237', '11238', '11239', '11354',
        ...
        '11429', '11430', '11432', '11433', '11434', '11435', '11436', '11691',
